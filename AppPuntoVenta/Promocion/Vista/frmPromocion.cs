...
namespace AppPuntoVenta.Promocion.Vista
{
    public partial class frmPromocion : Form
    {
        ...
        void AbrirDetallePromocion(string codigo, string tipo)
        {
            frmDetallePromocion detalle = new frmDetallePromocion();
        ...
        bool CamposValidos()
        {
            ...
            {
                MostrarMensajeInformacion("La fecha de fin no debe ser menor a la fecha de inicio");
                validos = false;
            }
            return validos;
        }
